...
const LogIn = ({ APIURL, setIsLoggedIn, getPostData, theme }) => {
        ...
        <>
            ...
            <Box
                ...
                <ThemeProvider theme={theme}>
                    ...
                    <FormControl>
                        <InputLabel htmlFor="password" color="primaryDark">Password *</InputLabel>
                        <OutlinedInput
                            id="password"
                    ...
                    <Button type="submit" variant="contained" color="primaryLight">Log In</Button>
